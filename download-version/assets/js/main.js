   ...
   $(window).scroll(function () {
    ...
    if ($('.hero-3').length > 0) {
        window.addEventListener('scroll', function() {
            ...
            $('.hero-shape1').css('transform', "translate(" + value * 0.3 + 'px' + "," + value * 0.3 + 'px' + ")");
            $('.hero-shape2').css('transform', "translate(" + value * -0.25 + 'px' + "," + value * -0.25 + 'px' + ")");
            // $('.star').css('transform', "rotate(" + value * 2 + 'deg' + ")");
            if (value == 0) {
                $('.star').css('animation-duration', 2 + "s");
            } else {
                $('.star').css('animation-duration', value * 0.003 + "s");
            }
        })
    };
